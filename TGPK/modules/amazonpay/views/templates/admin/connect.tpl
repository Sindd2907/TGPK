    ...
    <div class="row">
        <div class="col-xs-12 col-md-6">
            ...
            <ol>
                ...
                <li>
                    <a id="showstepconfiguration" href="#" onclick="jQuery('.nav-tabs a[href=#amazonpay_promotion]').tab('show');">{l s='[1]Promotion:[/1] Promote Amazon Pay on your website.' tags=['<span>'] mod='amazonpay'}</a>
                </li>
            </ol>
            <p>
                <br />

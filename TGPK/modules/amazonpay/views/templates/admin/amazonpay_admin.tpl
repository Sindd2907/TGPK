...
<ul class="nav nav-tabs" role="tablist" id="amazontabs">
	<li><a href="#amazonpay_connect" role="tab" data-toggle="tab">{l s='Connect' mod='amazonpay'}</a></li>
	<li class="active"><a href="#amazonpay_authentication" role="tab" data-toggle="tab">{l s='Authentication' mod='amazonpay'}</a></li>
	<li><a href="#amazonpay_configuration" role="tab" data-toggle="tab">{l s='Configuration' mod='amazonpay'}</a></li>
	<li><a href="#amazonpay_promotion" role="tab" data-toggle="tab">{l s='Promotion' mod='amazonpay'}</a></li>
...
<div class="tab-content">
	<div class="tab-pane" id="amazonpay_connect">{include file='./connect.tpl'}</div>
	<div class="tab-pane active" id="amazonpay_authentication">{include file='./authentication.tpl'}</div>
	<div class="tab-pane" id="amazonpay_configuration">{include file='./configuration.tpl'}</div>
	<div class="tab-pane" id="amazonpay_promotion">{include file='./promotion.tpl'}</div>

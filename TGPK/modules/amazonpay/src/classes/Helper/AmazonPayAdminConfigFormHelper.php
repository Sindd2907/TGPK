...
class AmazonPayAdminConfigFormHelper
{
    ...
    public static function getConfigForms(Amazonpay $module)
    {
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    */
                    ...
                    array(
                        'type' => 'categories',
                        'label' => $module->l('Disable Amazon Pay for products in the following categories'),
                        ...
                        'desc' => $module->l('You can select one or more categories.')
                    )
                ),
                'submit' => array(
                    'title' => $module->l('Save', self::TRANSLATIONKEY),
        ...
        $promo = array(
            'form' => array(
                'form' => array(
                    'id_form' => 'amazonpay_promo_form'
                ),
                'legend' => array(
                    'title' => $module->l('Promotion', self::TRANSLATIONKEY),
                    'icon' => 'icon-cogs',
                ),
                'input' => array(
                    array(
